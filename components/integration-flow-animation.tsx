...
const particles = [
  ...
  { path: pathDarkPaths[1], duration: "4.9s", delay: "-0.8s" },
  { path: pathDarkPaths[3], duration: "5.5s", delay: "-1.6s" },
  { path: pathDarkPaths[6], duration: "4.7s", delay: "-2.4s" },
  { path: pathDarkPaths[8], duration: "5.2s", delay: "-3.1s" },
  { path: pathDarkPaths[4], duration: "4.8s", delay: "-1.1s" },
  { path: pathDarkPaths[2], duration: "5.8s", delay: "-2.9s" },
  { path: pathDarkPaths[0], duration: "5.1s", delay: "-3.7s" },
] as const
